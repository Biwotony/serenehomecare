  ...
  return (
    <SiteShell>
      <main id="main-content">
        <PageIntro eyebrow="Careers in Eldoret" title="Bring skill, respect and accountability into every home" description="Serene welcomes introductions from care professionals who understand role boundaries, safeguarding, privacy and person-centred support." />
